...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cadangan);
        ...
        try{
            ...
            if (email != null && email.length() >0){
                ...
                Toast.makeText(LoginActivity.this, "Registered Success Please Login", Toast.LENGTH_LONG).show();
            }
        }catch (Exception e){
            System.out.print(e);
        }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            asyncRequestObject.execute(getResources().getString(R.string.url_valid)+serverUrl, command, email, password,token);
    ...
    private class AsyncDataClass extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("TOKEN_ID", params[4]));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                userId = resultObject.getString("USER_ID");
                userName = resultObject.getString("USERNAME");
                enteredEmail = resultObject.getString("EMAIL");
                birthDate = resultObject.getString("BIRTH_DATE");
                fullName = resultObject.getString("FULL_NAME");
                password = resultObject.getString("PASSWORD");
                noTelp = resultObject.getString("PHONE_NUMBER");
            ...
            if (jsonResult == 2) {
                ...
                sharedPrefManager.saveSPString(SharedPrefManager.SP_EMAIL, enteredEmail);
                ...
                sharedPrefManager.saveSPString(SharedPrefManager.SP_BIRTHDATE, birthDate);
                sharedPrefManager.saveSPString(SharedPrefManager.SP_FULL_NAME, fullName);
