...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBirthdate = (EditText) findViewById(R.id.regtanggallahir);
        ...
        mRePasswordView = (EditText) findViewById(R.id.regrepassword);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            asyncRequestObject.execute(getString(R.string.url_valid) + serverUrl, command, email,username,fullname,birthdate, password);
    ...
    private class AsyncDataClass extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (jsonResult == 1) {
                ...
                intent.putExtra("MESSAGE", "You have been successfully register");
                ...
                showProgress(false);
                mUsername.setError("Username is already");
